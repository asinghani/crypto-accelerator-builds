...
set ::env(CELL_PAD) "8"
set ::env(MERGED_LEF) "/project/openlane/user_project_wrapper2/runs/user_project_wrapper2/tmp/merged.lef"
set ::env(MERGED_LEF_UNPADDED) "/project/openlane/user_project_wrapper2/runs/user_project_wrapper2/tmp/merged_unpadded.lef"
set ::env(TRACKS_INFO_FILE) "/project/openlane/user_project_wrapper2/runs/user_project_wrapper2/tmp/tracks_copy.info"
...
set ::env(DESIGN_DIR) "/project/openlane/user_project_wrapper2"
set ::env(CLOCK_PORT) "wb_clk_i"
set ::env(CLOCK_NET) "wb_clk_i"
# Synthesis config
set ::env(LIB_SYNTH) "/project/openlane/user_project_wrapper2/runs/user_project_wrapper2/tmp/trimmed.lib"
...
set ::env(SYNTH_MAX_TRAN) "[expr {0.1*33}]"
...
set ::env(CURRENT_DEF) /project/openlane/user_project_wrapper2/runs/user_project_wrapper2/results/routing/user_project_wrapper.def
set ::env(CURRENT_NETLIST) /project/openlane/user_project_wrapper2/runs/user_project_wrapper2/results/lvs/user_project_wrapper.lvs.powered.v
set ::env(PREV_NETLIST) /project/openlane/user_project_wrapper2/runs/user_project_wrapper2/results/synthesis/user_project_wrapper.synthesis_preroute.v
